...
const StoryViewer = ({viewStory, setViewStory}) => {
        ...
        switch (viewStory.media_type){
            case 'image':
                ...
                return(
                  ...
                  case 'text':
                return(
                    <div alt="" className ='w-full h-full flex items-center justify-center p-8 text-white text-2xl text-center'>{viewStory.content}</div>
                );
               default:
                return null;
        }
    ...
    return (
        <div className ='fixed inset-0 h-screen bg-black bg-opacity-75 z-110 flex items-center justify-center'
        style={{backgroundColor: viewStory.media_type === 'text' ? (viewStory.background_color || viewStory.backgroundColor) : '#000000' }}>
