         ...
         ${sidebarOpen ? 'translate-x-0' : 'max-sm:-translate-x-full'}
          transition-all duration-300 ease-in-out `}>
            <div className='w-full'>
                ...
                mt-6 mx-6 rounded-lg bg-linear-to-r from-indigo-500 to-purple-600 hover:from-indigo-700 hover:to-purple-800
            ...
            <div className='w-full border-t border-gray-200 p-4 px-7 flex item-center justify-between'>
                ...
                <LogOut onClick = {signOut} className= 'w-4.5 text-gray-400 not-last:hover:text-gray-700 transition cursor-pointer' />
            </div>
        </div>
    )
}
