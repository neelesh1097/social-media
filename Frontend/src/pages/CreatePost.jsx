    ...
    <div className='min-h-screen bg-gradient-to-b from-slate-50 to-white'>
      <div className='max-w-6xl mx-auto p-6'>
           ...
           <div className='mb-8'>
            ...
            <p className='text-slate-600'>Share your thoughts with others</p>
           </div>
           {/* form */}
           <div className='max-w-xl bg-white p-4 sm:p-8 sm:pb-3 rounded-xl shadow-md space-y-4'>
            {/* Header */}
               ...
               {/* text area */}
               <textarea className='w-full resize-none max-h-20 mt-4 text-sm outline-none placeholder-gray-400' id="" placeholder='whats happening' 
