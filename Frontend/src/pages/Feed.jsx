    ...
    xl:pr-5 flex items-start justify-center xl:gap-8'>
      ...
      <div className ='max-xl:hidden sticky top-0'>
        <div className='max-w-xs bg-white text-xs p-4 rounded-md inline-flex flex-col gap-2 shadow'>
          ...
          <p className='text-slate-400'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Amet labore ipsam saepe illo ullam fugit provident aut maxime voluptates eveniet.</p>
          </div>
          <RecentMessages />
      </div>
    </div>
