  ...
  return (
    <div className='min-h-screen relative bg-slate-50'>
      <div className='max-w-6xl mx-auto p-6'>
        <div className='mb-8'>
          <h1 className='text-xl font-bold text-slate-900 mb-2'>Messages</h1>
          <p className='text-slate-600'>Talk to you friends</p>
        </div>
           ...
           {dummyConnectionsData.map((user)=>(
            <div key={user._id} className = 'max-w-xl flex flex-wrap gap-5 p-6 bg-white shadow rounded-md'>
              ...
              <div className ='flex flex-col gap-2 mt-4'>
                ...
                <button onClick={()=> navigate(`/message/${user._id}`)} className='size-10 flex items-center justify-center text-sm rounded
